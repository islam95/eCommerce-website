...
?>
	...
	<div class="fb-comments" data-href="https://smcse.city.ac.uk/student/acjx557/khizir.com/index.php?page=product&category=<?php echo $category['id']; ?>&id=<?php echo $product['id']; ?>" 
		data-width="600px" data-numposts="5" data-colorscheme="light"></div>
